...
class ProductViewSet(viewsets.ModelViewSet):
    ...
    permission_classes = [permissions.IsAuthenticatedOrReadOnly, IsFarmerOrSupplier, IsOwnerOrReadOnly]
    ...
    @action(detail=True, methods=['post'], permission_classes=[IsFarmerOrSupplier, IsOwnerOrReadOnly])
